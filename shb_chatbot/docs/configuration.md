...
|----------|---------|-------------|
| `PROJECT_NAME` | `shb_chatbot` | Display name for the project |
...
| `POSTGRES_DB` | `shb_chatbot` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `shb_chatbot` | Service name in Logfire dashboard |
