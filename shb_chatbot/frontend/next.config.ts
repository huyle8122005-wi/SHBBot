...
const ContentSecurityPolicy = `
  ...
  font-src 'self' data:;
  connect-src 'self' ws: wss: http://localhost:* https://localhost:* *.onrender.com https://*.onrender.com wss://*.onrender.com shbbot.onrender.com wss://shbbot.onrender.com *.pages.dev https://*.pages.dev;
